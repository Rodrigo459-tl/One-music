...
<body>
                            ...
                            <div class="classynav">
                                ...
                                <div class="login-register-cart-button d-flex align-items-center">
                                    ...
                                    <div class="login-register-btn mr-50">
                                        <a href="../../index.php" id="loginBtn">Login / Log out</a>
                                    </div>
            ...
            <div class="row">
                <div class="col-12 col-lg-9">
                    ...
                    <div class="single-blog-post mb-100 wow fadeInUp" data-wow-delay="100ms">
                        ...
                        <div class="blog-post-thumb mt-30">
                            <a href="#"><img src="../../recursos/recursos_panel/img/bg-img/blog1.jpg" alt=""></a>
                            <!-- Post Date -->
                            <div class="post-date">
                                <span>15</span>
                                <span>June ‘18</span>
                    ...
                    <div class="single-blog-post mb-100 wow fadeInUp" data-wow-delay="100ms">
                        <!-- Post Thumb -->
                        <div class="blog-post-thumb mt-30">
                            <a href="#"><img src="../../recursos/recursos_panel/img/bg-img/blog2.jpg" alt=""></a>
                            <!-- Post Date -->
                            <div class="post-date">
                                <span>15</span>
                                <span>June ‘18</span>
                    ...
                    <div class="single-blog-post mb-100 wow fadeInUp" data-wow-delay="100ms">
                        <!-- Post Thumb -->
                        <div class="blog-post-thumb mt-30">
                            <a href="#"><img src="../../recursos/recursos_panel/img/bg-img/blog3.jpg" alt=""></a>
                            <!-- Post Date -->
                            <div class="post-date">
                                <span>15</span>
                                <span>June ‘18</span>
                ...
                <div class="col-12 col-lg-3">
                    <div class="blog-sidebar-area">
                        ...
                        <!-- Widget Area -->
                        <div class="single-widget-area mb-30">
                            <a href="#"><img src="../../recursos/recursos_panel/img/bg-img/add.gif" alt=""></a>
                        </div>

                        <!-- Widget Area -->
                        <div class="single-widget-area mb-30">
                            <a href="#"><img src="../../recursos/recursos_panel/img/bg-img/add2.gif" alt=""></a>
                        </div>
    ...
    <section class="contact-area section-padding-100 bg-img bg-overlay bg-fixed has-bg-img"
        style="background-image: url(../../recursos/recursos_panel/img/bg-img/bg-2.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-12">
        ...
        <div class="container">
            <div class="row d-flex flex-wrap align-items-center">
                <div class="col-12 col-md-6">
                    <a href="./dashboard.php"><img src="../../recursos/recursos_panel/img/core-img/logo.png" alt=""></a>
