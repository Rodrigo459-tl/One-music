            ...
            <div class="classy-nav-container breakpoint-off">
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between" id="oneMusicNav">
                        ...
                        <!-- Nav brand -->
                        <a href="./dashboard.php" class="nav-brand"><img src="../../recursos/recursos_panel/img/core-img/logo.png" alt=""></a>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    <div class="testimonials-area mb-100 bg-img bg-overlay"
                        style="background-image: url(../../recursos/recursos_panel/img/bg-img/bg-3.jpg);">
