...
<body>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="userDropdown">
                                                    <a class="dropdown-item text-dark"
                                                        href="../../backend/panel/liberar_usuario.php">Cerrar sesión</a>
                                                </div>
                                            </div>
                                        <?php else: ?>
        ...
        <div class="hero-slides owl-carousel">
            ...
            <div class="single-hero-slide d-flex align-items-center justify-content-center">
                ...
                <div class="slide-img bg-img"
                    style="background-image: url(../../../recursos/recursos_panel/img/bg-img/bg-1.jpg);"></div>
                <!-- Slide Content -->
                <div class="container">
                    <div class="row">
                        <div class="col-12">
            ...
            <div class="single-hero-slide d-flex align-items-center justify-content-center">
                <!-- Slide Img -->
                <div class="slide-img bg-img"
                    style="background-image: url(../../../recursos/recursos_panel/img/bg-img/bg-2.jpg);"></div>
                <!-- Slide Content -->
                <div class="container">
                    <div class="row">
                        <div class="col-12">
    ...
    <section class="featured-artist-area section-padding-100 bg-img bg-overlay bg-fixed"
        style="background-image: url(../../../recursos/recursos_panel/img/bg-img/bg-4.jpg);">
        <div class="container">
        ...
        <div class="container">
            <div class="row d-flex flex-wrap align-items-center">
                <div class="col-12 col-md-6">
                    <a href="./dashboard.php"><img src="../../../../recursos/recursos_panel/img/core-img/logo.png"
                            alt=""></a>
